...
public class PostDumpFlow {
    ...
    private static final String PROJECT_ID = "around-249121";
    ...
    public static void main(String[] args){
        ...
        PCollection<TableRow> bqRows = btRows.apply(ParDo.of(new DoFn<Result, TableRow>(){
            ...
            public void processElement(ProcessContext c) {
                ...
                TableRow row = new TableRow(); // This is a BigQuery table row obj
        ...
        bqRows.apply(BigQueryIO.Write
            .named("Write")
            .to(PROJECT_ID + ":" + "post_analysis" + "." + "dauly_dump_1") //table name
            .withSchema(schema)
